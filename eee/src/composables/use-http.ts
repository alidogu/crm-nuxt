...
export default () => {
    return {
        ...
        $get: <T>(url: string, params?: SearchParameters, option?: RequestOptions) => {
            return _fetch<T>('https://php.mmxiaowu.com'+url, params, { method: 'GET', ...option })
        },
        /**
         * $fetch.POST 封装
         * @param url api地址
        ...
        $post: <T>(url: string, params?: SearchParameters, option?: RequestOptions) => {
            return _fetch<T>('https://php.mmxiaowu.com'+url, params, { method: 'POST', ...option })
        },
        /**
         * useFetch.GET 封装
         * @param url api地址
        ...
        get: <T>(url: UrlType, params?: SearchParameters, option?: RequestOptions) => {
            return _useFetch<T>('https://php.mmxiaowu.com'+url, params, { method: 'GET', ...option })
        },
        /**
         * useFetch.POST 封装
         * @param url api地址
        ...
        post: <T>(url: UrlType, params?: SearchParameters, option?: RequestOptions) => {
            return _useFetch<T>('https://php.mmxiaowu.com'+url, params, { method: 'POST', ...option })
        },
    }
}
